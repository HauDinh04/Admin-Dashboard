...
const TopBar = () => {
  ...
  return (
    <div className="sticky top-0 z-0 w-full flex justify-between items-center px-8 py-4 b-blue-2 shadow-xl lg:hidden">
      ...
      <div className=" relative flex gap-4  items-center">
        <MenuIcon className="cursor-pointer md:hidden" onClick={()=>setDropdownMenu(!dropdownMenu)}/>
          {dropdownMenu &&(
            <div className=" absolute top-10 right-6 flex flex-col gap-8 p-5 bg-white shadow-xl rounded-md">
            {navLinks.map((link)=>(
